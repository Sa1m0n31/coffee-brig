		...
		<label style="overflow: hidden; zoom: 1;">
			...
			<p>
				<?php
					...
					printf( esc_html__( 'Why not leave us a review on %1$sWordPress.org%2$s?  We\'d really appreciate it!', 'storefront' ), '<a href="https://storefront.org/themes/storefront">', '</a>' );
				?>
			</p>
